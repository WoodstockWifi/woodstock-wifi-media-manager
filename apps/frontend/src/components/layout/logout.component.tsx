      ...
      <button
        ...
        className={
          isIcon
            ...
            : 'inline-flex h-[44px] w-full items-center justify-center rounded-[8px] border border-[#ff2364]/40 bg-[#ff2364]/10 px-[16px] text-[14px] font-[700] text-[#ff2364] transition-colors hover:bg-[#ff2364] hover:text-white'
        }
        onClick={logout}
      ...
      >
        {isIcon ? (
          <svg
            ...
            data-tooltip-content={t('log_out', 'Log out')}
          >
            <path
